...
export class IdPoolWrapper {
    ...
    private initRoles() {
        this.authRole = new Role(this.scope, 'CognitoDefaultAuthenticatedRole', {
        ...
        this.unauthRole = new Role(this.scope, 'CognitoDefaultUnauthenticatedRole', {
            assumedBy: new FederatedPrincipal('cognito-identity.amazonaws.com', {
                StringEquals: {
                    'cognito-identity.amazonaws.com:aud': this.identityPool.ref
                },
